                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="nav ml-3 nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                              ...
                              <a class="nav-link" href="{{ route('home') }}"  aria-selected="true">Home</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" href="/grade" role="tab" aria-selected="false">Grade</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" href="/subject" role="tab"  aria-selected="false">Subject</a>
                            </li>
                          </ul>
