		...
		<div class="card-body">
                    ...
                    <form method="POST" action="{{ route('question.update', $question->id) }}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('body') is-invalid @enderror" name="body" id="body" required rows="3">{{ $question->body }}</textarea>
                            </div>
                                @error('body')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('explanation') is-invalid @enderror" name="explanation" id="explanation" required rows="3">{{ $question->explanation }}</textarea>
                            </div>
                                @error('explanation')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                <div class="card">
								  ...
								  <div class="card-body">
                                      ...
                                      <input id="correct_answer" type="text" class="form-control @error('correct_answer') is-invalid @enderror" value="{{ $question->correct_answer }}" name="correct_answer" required autofocus>
                                    ...
                                    <input id="incorrect_answer_1" type="text" class="form-control @error('incorrect_answer_1') is-invalid @enderror" value="{{ $question->incorrect_answer_1 }}" name="incorrect_answer_1" value="{{old('incorrect_answer_1')}}" required autofocus>
                                    ...
                                    <input id="incorrect_answer_2" type="text" class="form-control @error('incorrect_answer_2') is-invalid @enderror" value="{{ $question->incorrect_answer_2 }}" name="incorrect_answer_2" value="{{old('incorrect_answer_2')}}" required autofocus>
                                    ...
                                    <input id="incorrect_answer_3" type="text" class="form-control @error('incorrect_answer_3') is-invalid @enderror" value="{{ $question->incorrect_answer_3}}" name="incorrect_answer_3" value="{{old('incorrect_answer_3')}}" required autofocus>
